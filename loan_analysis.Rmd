...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data, aes(x=ProsperScore, y=Current_Delinquincies)) + geom_jitter(color="dark blue")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data, aes(x=ListingCategory, y=Current_Delinquincies)) + geom_jitter(color="dark red")
```
...
ggplot(data, aes(x=Credit_Score_Lower, y=Current_Delinquincies)) + geom_bar(stat='identity', aes(color=Credit_Score))
...
ggplot(Current_Delinq_Monthly_Income, aes(x=StatedMonthlyIncome, 
                                          y=CurrentDelinquencies))  + geom_jitter(alpha= 1/9, aes(color=Income_Class)) + ggtitle("Delinquencies and Income") + labs(x="Monthly Income", y="Delinquencies")
```
...
ggplot(Current_Delinq_Debt, aes(x=DebtToIncomeRatio,
                                y=CurrentDelinquencies)) + geom_jitter(alpha=1/9, aes(color=Ratio_Quartiles)) + ggtitle("Delinquencies and Debt to Income Ratios") + labs(x="Debt to Income Ratio", y="Delinquencies")
...
Income_Class <- cut(Current_Delinq_Monthly_Income$StatedMonthlyIncome, breaks=breaks2, labels=c("Below Minimum Wage", "Below Median Wage", "Upper Middle Class", "Educated Professional", "Upper Class"))
ggplot(Current_Delinq_Monthly_Income, aes(x=StatedMonthlyIncome, 
                                          y=CurrentDelinquencies))  + geom_jitter(alpha= 1/9, aes(color=Income_Class)) + ggtitle("Delinquencies and Income") + labs(x="Monthly Income $", y="# of Delinquencies")
```
...
ggplot(data, aes(x=Credit_Score_Lower, 
                 y=Current_Delinquincies)) + geom_jitter(alpha=1/9, aes(color=Credit_Score_Groups)) + ggtitle("Delinquencies and Credit Score") + labs(x="Credit Score", y="# of Delinquencies")
```
...
Ratio_Quartiles <- cut(Current_Delinq_Debt$DebtToIncomeRatio, breaks=breaks3, labels=c("Q1", "Q2", "Q3", "Q4"))
ggplot(Current_Delinq_Debt, aes(x=DebtToIncomeRatio,
                                y=CurrentDelinquencies)) + geom_jitter(alpha=1/9, aes(color=Ratio_Quartiles)) + ggtitle("Delinquencies and Debt to Income Ratios") + labs(x="Debt to Income Ratio", y="# of Delinquencies")
```

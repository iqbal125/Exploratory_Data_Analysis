...
Another Important factor to keep in mind would be someone's occupation. We can explore if someone's job would affect their loan repayment ability.
```{r echo=FALSE, message=FALSE, warning=FALSE}
Job <- data['Occupation']
summary(Job)

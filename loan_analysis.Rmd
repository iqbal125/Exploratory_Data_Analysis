...
ggplot(Credit_Score_Lower_Non0, aes(x=CreditScoreRangeLower)) + geom_bar()
...
ggplot(Credit_Score_Upper2, aes(x=CreditScoreRangeUpper)) + geom_bar()
```
...
ggplot(temp, aes(x= reorder(CreditGrade, CreditGrade, function(x) - length(x)))) + geom_bar()
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data, aes(x=BorrowerAPR, y=Current_Delinquincies)) + geom_jitter(alpha=1/8, color="red")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data, aes(x=ProsperScore, y=Current_Delinquincies)) + geom_jitter(alpha=1/10, color="dark blue")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data, aes(x=ListingCategory, y=Current_Delinquincies)) + geom_jitter(alpha=1/10,color="dark red")
```
...
ggplot(Credit_Score_Lower_Non0, aes(x=CreditScoreRangeLower, y=CurrentDelinquencies)) + geom_jitter(alpha= 1/10, color="blue")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data, aes(x=DelinquinceiesLast7Years, y=Current_Delinquincies)) + geom_jitter(alpha=1/10, color="purple")
```
...
ggplot(Current_Delinq_Monthly_Income, aes(x=StatedMonthlyIncome, y=CurrentDelinquencies)) + geom_jitter(alpha=1/14, color="green")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(df3, aes(x=Credit_Lines, y=Current_Delinquincies)) + geom_jitter(alpha=1/6, color='aqua marine')
```

Debt to income does not seem to have an effect on delinquencies, expect for people with a Income to debt ratio of 10. 
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data, aes(x=Debt_to_income_ratio, y=Current_Delinquincies)) + geom_jitter(alpha=1/8, color='blue')
```
...
Credit_Score <- cut(data$CreditScoreRangeLower, breaks=breaks1, labels=c('Low','Medium','High'))
ggplot(data, aes(x=Credit_Score_Lower, y=Current_Delinquincies)) + geom_bar(stat='identity', aes(fill=Credit_Score))
...
ggplot(data, aes(x=Credit_Score_Lower, y=Current_Delinquincies)) + geom_point(color="red") + facet_grid(data$IsBorrowerHomeowner ~ .)
...
ggplot(Current_Delinq_Monthly_Income, aes(x=StatedMonthlyIncome, 
                                          y=CurrentDelinquencies))  + geom_jitter(alpha= 1/9, aes(color=Income_Class)) + guides(colour =guide_legend(override.aes = list(alpha=1))) + ggtitle("Delinquencies and Income") + labs(x="Monthly Income", y="Delinquencies")
```
...
ggplot(Current_Delinq_Debt, aes(x=DebtToIncomeRatio,
                                y=CurrentDelinquencies)) + geom_jitter(alpha=1/9, aes(color=Ratio_Quartiles)) + guides(colour =guide_legend(override.aes = list(alpha=1))) + ggtitle("Delinquencies and Debt to Income Ratios") + labs(x="Debt to Income Ratio", y="Delinquencies")
...
ggplot(Current_Delinq_Debt, aes(x=DebtToIncomeRatio, y=CurrentDelinquencies)) + geom_jitter(color='red3', alpha=1/7, aes(color=df12))
```
...
Income_Class <- cut(Current_Delinq_Monthly_Income$StatedMonthlyIncome, breaks=breaks2, labels=c("Below Minimum Wage", "Below Median Wage", "Upper Middle Class", "Educated Professional", "Upper Class"))
ggplot(Current_Delinq_Monthly_Income, aes(x=StatedMonthlyIncome, 
                                          y=CurrentDelinquencies))  + geom_jitter(alpha= 1/9, aes(color=Income_Class)) + guides(colour =guide_legend(override.aes = list(alpha=1))) + ggtitle("Delinquencies and Income") + labs(x="Monthly Income $", y="# of Delinquencies")
```
...
ggplot(data, aes(x=Credit_Score_Lower, 
                 y=Current_Delinquincies)) + geom_jitter(alpha=1/9, aes(color=Credit_Score_Groups)) + guides(colour =guide_legend(override.aes = list(alpha=1))) + ggtitle("Delinquencies and Credit Score") + labs(x="Credit Score", y="# of Delinquencies")
```
...
Ratio_Quartiles <- cut(Current_Delinq_Debt$DebtToIncomeRatio, breaks=breaks3, labels=c("Q1", "Q2", "Q3", "Q4"))
ggplot(Current_Delinq_Debt, aes(x=DebtToIncomeRatio,
                                y=CurrentDelinquencies)) + geom_jitter(alpha=1/9, aes(color=Ratio_Quartiles)) + guides(colour =guide_legend(override.aes = list(alpha=1))) + ggtitle("Delinquencies and Debt to Income Ratios") + labs(x="Debt to Income Ratio", y="# of Delinquencies")
```
